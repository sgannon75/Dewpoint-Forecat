    ...
    <div style={{
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 12 }}>
        <div style={{ flex: 1 }}>
          ...
          {isToday && day.highHour && <div style={{ color: "#7ec8e3", fontSize: 11, fontFamily: "'Space Mono', monospace" }}>({day.highHour.label})</div>}
        </div>
        <div style={{ flex: 1 }}>
          ...
          {isToday && day.lowHour && <div style={{ color: "#7ec8e3", fontSize: 11, fontFamily: "'Space Mono', monospace" }}>({day.lowHour.label})</div>}
        </div>
        <div style={{ flex: 1 }}>
